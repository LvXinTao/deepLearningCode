...
def parse_train_args(parser):
    ...
    parser.add_argument('--train_list',type=str,default='/root/autodl-tmp/imagenet100/train_list.txt',
                        help='Train list')
    parser.add_argument('--save_model_dir',type=str,default='/root/deepLearningCode/checkpoints/MobileNet_v2',
    ...
    parser.add_argument('--load_pretrain_path',type=str,default="",
...
def parse_test_args(parser):
    parser=parse_common_args(parser)
    parser.add_argument('--save_result_dir',type=str,default='/root/deepLearningCode/checkpoints/MobileNet_v2',
